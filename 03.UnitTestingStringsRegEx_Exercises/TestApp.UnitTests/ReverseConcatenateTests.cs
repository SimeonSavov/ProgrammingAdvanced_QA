...
public class ReverseConcatenateTests
{
    ...
    {
        // Arrange
        string[] input = new[] { "alabala", "123", "abc", "alabala", "123", "abc", "alabala", "123", "abc", "alabala", "123", "abc" };

        // Act
        string result = ReverseConcatenate.ReverseAndConcatenateStrings(input);

        // Assert
        Assert.That(result, Is.EqualTo("abc123alabalaabc123alabalaabc123alabalaabc123alabala"));
    }
}
